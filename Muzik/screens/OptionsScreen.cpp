...
card(card), screenType(screenType), number(number), deckId(deckId) {
	...
	if (screenType == ST_LOGIN_OPTIONS) {
		mainLayout = Util::createMainLayout("", "Teken uit", "", true);
	}
	else {
	...
	switch(screenType) {
		...
		case ST_AUCTION_OPTIONS:
			label = Util::createSubLabel("My veilings");
			label->addWidgetListener(this);
			kinListBox->add(label);
			label = Util::createSubLabel("Skep nuwe veiling");
			label->addWidgetListener(this);
			kinListBox->add(label);
			break;
		...
		case ST_CARD_OPTIONS:
			label = Util::createSubLabel("Notas");
			label->addWidgetListener(this);
			kinListBox->add(label);
		...
		case ST_LOGIN_OPTIONS:
			label = Util::createSubLabel("Teken in");
			label->addWidgetListener(this);
			kinListBox->add(label);
			label = Util::createSubLabel("Sluit aan");
			label->addWidgetListener(this);
			kinListBox->add(label);
			break;
	}
