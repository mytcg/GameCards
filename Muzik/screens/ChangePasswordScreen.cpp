...
ChangePasswordScreen::ChangePasswordScreen(Feed *feed, MainScreen *previous) : mHttp(this) {
	...
	mainLayout = Util::createMainLayout("Change", "Terug", "", true);
	...
	editBoxOldPass = new NativeEditBox(0, 0, label->getWidth()-PADDING*2, label->getHeight()-PADDING*2, 64, MA_TB_TYPE_ANY, label, "",L"E-pos adres");
	...
	label = Util::createEditLabel("");
	editBoxNewPass = new NativeEditBox(0, 0, label->getWidth()-PADDING*2, label->getHeight()-PADDING*2, 64, MA_TB_TYPE_ANY, label, "",L"E-pos adres");
	...
	label = Util::createEditLabel("");
	editBoxConfirm = new NativeEditBox(0, 0, label->getWidth()-PADDING*2, label->getHeight()-PADDING*2, 64, MA_TB_TYPE_ANY, label, "",L"E-pos adres");
